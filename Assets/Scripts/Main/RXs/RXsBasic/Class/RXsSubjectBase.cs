...
namespace Main.RXs
{
        ...
        IRXsSubject<TObserver, TObservable>
    {
        ...
        IRXsDisposable IRXsObservable<TObservable>.Subscribe(IRXsObserver<TObservable> observer) => Subscribe(observer.ToRXsObserverSubscription());
        ...
        IRXsDisposable IRXsObservable.Subscribe(IRXsObserver observer) => Subscribe(observer.ToRXsObserverSubscription<TObservable>());
        protected virtual IRXsDisposable Subscribe(IRXsObserverSubscription<TObservable> observer)
        {
