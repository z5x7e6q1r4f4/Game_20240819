...
namespace Main.RXs
{
    public interface IRXsCollection_Readonly : IEnumerable
    {
        ...
        IRXsObservableImmediately<IRXsCollection_AfterAdd> AfterAdd { get; }
    ...
    public interface IRXsCollection_Readonly<T> : IRXsCollection_Readonly, IEnumerable<T>
    {
        ...
        IRXsObservableImmediately<IRXsCollection_AfterAdd> IRXsCollection_Readonly.AfterAdd => AfterAdd;
        ...
        new IRXsObservableImmediately<IRXsCollection_AfterAdd<T>> AfterAdd { get; }
