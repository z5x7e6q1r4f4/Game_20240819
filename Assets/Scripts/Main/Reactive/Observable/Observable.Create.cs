...
namespace Main
{
    public static partial class Observable
    {
        public static ObservableFromAction<T> Create<T>(
            Func<ObservableFromAction<T>, IObserverBase<T>, IDisposable> onSubscribe = null,
        ...
        public static ObservableFromAction<T> Create<T>(
         Func<IObserverBase<T>, IDisposable> onSubscribe = null,
         Action onDispose = null)
            => Create<T>(
                onSubscribe != null ? (_, observer) => onSubscribe(observer) : null,
                onDispose != null ? _ => onDispose() : null);
        public static ObservableFromAction<T> Create<T>()
            => Create(default(Func<ObservableFromAction<T>, IObserverBase<T>, IDisposable>));
    }
}
