...
namespace Main.RXs.ObservableCollections
{
    ...
    {
        [Test]
        public void Test_BaforeAdd_Data([Values(0, 1, 2)] int index, [Values("a", "b", "c")] string item)
        {
        ...
        [Test]
        public void Test_BaforeAdd_Count([Values] bool beforeAdd)
        {
            var count = 0;
        ...
        [Test]
        public void Test_BaforeAdd_IsEnable([Values] bool isEnable)
        {
        ...
        [Test]
        public void Test_BaforeAdd_Modified([Values(null, "modified")] string modified)
        {
